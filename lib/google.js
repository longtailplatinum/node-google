...
let COUNTRY_CODES_TO_UULE = [
    ...
    {cc: 'au', tld: 'com.au', name: 'Australia', uule: 'w+CAIQIFISCd_Fh2cH_SsrEVITW5WhZ4JT'},
...
let igoogle = function(query, sedb, lang, start, proxy, cert, serpResults, callback) {
    let URL = '%s://www.google.%s/search?hl=%s&q=%s&uule=%s&ip=0.0.0.0&source_ip=0.0.0.0&ie=UTF-8&oe=UTF-8&noj=1&igu=1&nomo=1&nota=1&biw=1075&bih=5000&date='+ new Date().getTime();
