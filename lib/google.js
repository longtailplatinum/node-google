...
var COUNTRY_CODES_TO_UULE = [
    ...
    { cc: 'uy', tld: 'com.uy', name: 'Uruguay', uule: 'w+CAIQICIHVmlldG5hbQ' },
    { cc: 've', tld: 'co.ve', name: 'Venezuela', uule: 'w+CAIQICIHVmlldG5hbQ' },
...
var URL = '%s://www.google.%s/search?hl=%s&q=%s&uule=%s&sa=N&ie=UTF-8&oe=UTF-8&gws_rd=ssl&gl=%s';
...
var igoogle = function(query, sedb, lang, start, proxy, cert, callback) {
