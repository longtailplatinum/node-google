...
let COUNTRY_CODES_TO_UULE = [
    ...
    {cc: 'in', tld: 'co.in', name: 'India', uule: 'w+CAIQICIRRGVsaGksRGVsaGksSW5kaWE='},
    ...
    {cc: 'nz', tld: 'co.nz', name: 'New Zealand', uule: 'w+CAIQICIdQXVja2xhbmQsQXVja2xhbmQsTmV3IFplYWxhbmQ='},
